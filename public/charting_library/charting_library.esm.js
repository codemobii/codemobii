...
const o = class {
  constructor(n) {
    ...
    if (((this._options = e(i, n)), n.preset)) {
      const e = t[n.preset];
      e
        ...
        : console.warn('Unknown preset: `' + n.preset + '`');
    }
...
(window.TradingView = window.TradingView || {}),
  (window.TradingView.version = n);
export { n as version, o as widget };
